...
%   Lindstedt-Poincaré approximation, subject to the J2 perturbation
...
% Define constant auxiliary variables k_beta, k_{\omega_1}, and k_{\omega_2}
extendedStateInitial = [extendedStateInitial; 1/beta; w1/w0];
if expansionOrder == 2
    extendedStateInitial = [extendedStateInitial; w2/w0];
end

%% Load operator matrix "M", and matrix with monomials "mons"
M = load(sprintf("Data/j2LP_m_order%d.txt", expansionOrder));
mons = load(sprintf("Data/j2LP_mons_order%d.txt", expansionOrder));
